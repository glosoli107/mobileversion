  ...
  def create
    ...
    respond_to do |format|
      if @new_message.save
        ...
        format.html {|htlml| html.phone { redirect_to "/wedding/contact", notice: 'Your message has been sent. Thank you!' }}
        ...
        format.html {|htlml| html.phone { redirect_to "/wedding/contact", alert: "You must enter your name, email address, and message before sending the message." }}
