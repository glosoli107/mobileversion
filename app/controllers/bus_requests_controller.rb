  ...
  def create
    ...
    respond_to do |format|
      if @bus_request.save
        ...
        format.html {|htlml| html.phone {redirect_to "/wedding/contact", notice: 'Your request has been submitted. We will email you a confirmation before the wedding. Thank you!'}}
        ...
        format.html {|htlml| html.phone {redirect_to "/wedding/contact", alert: "You must enter your email address and one or more names before submitting the request."}}
